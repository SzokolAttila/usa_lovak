...
class HorseController extends Controller
{
    public function index() : View
    {
        return view("horse.index", [
            "title" => "Az USA államainak nemzeti lovai"
        ]);
    }
    public function list() : View
    {
        return view("horse.list", [
            "title" => "Az USA államainak nemzeti lovai (Felsorolás)",
    ...
    public function table() : View
    {
        return view("horse.table", [
            "title" => "Az USA államainak nemzeti lovai (Táblázat)",
            "horses" => $this->getHorses()
        ]);
    }
    public function grid() : View
    {
        return view("horse.grid", [
            "title" => "Az USA államainak nemzeti lovai (Grid)",
            "horses" => $this->getHorses()
        ]);
    }
